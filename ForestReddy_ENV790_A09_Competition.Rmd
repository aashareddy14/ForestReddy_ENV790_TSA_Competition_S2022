...
```{r}
SARIMA_autofit_2009_temp <- auto.arima(demand_train_ts, xreg = temp_train)
checkresiduals(SARIMA_autofit_2009_temp)
```
...
```{r}
# forecast for Jan 2010
SARIMA_forecast_Jan_2010_temp <- forecast::forecast(SARIMA_autofit_2009_temp, h = 31, 
                                                    xreg = jan_2010_temp)
SARIMA_scores_Jan_2010_temp <- accuracy(SARIMA_forecast_Jan_2010_temp$mean,test)
SARIMA_scores_Jan_2010_temp
plot(SARIMA_forecast_Jan_2010_temp)
```
...
# forecast for Jan 2011 (this is what we submit to kaggle)
SARIMA_forecast_Jan_2011 <- forecast::forecast(SARIMAX_temp_autofit_2010,h = 31, xreg = jan_2010_temp) # ASSUMES THE SAME TEMP AS 2010! 
...
scores <- as.data.frame(
  rbind( SARIMA_scores_Jan_2010, SARIMA_scores_Jan_2010_temp)
  )
row.names(scores) <- c( "SARIMA(1,2,2)","SARIMAX(3,0,2)_temp")
